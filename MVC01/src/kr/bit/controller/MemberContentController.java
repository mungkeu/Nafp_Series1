...
public class MemberContentController extends HttpServlet {
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		out.println("<input type='hidden' name='num' value='"+vo.getNum()+"'/>"); // 눈에 보이지 않는다. 식별을 위해 키를 같이 보내줘야한다.
		out.println("<table class='table table-bordered'>");
		if(vo!=null) {
			out.println("<tr><td colspan='2'>"+vo.getName()+" 회원의 상세보기</td></tr>");
			out.println("<tr>");
		...
		out.println("<input type='submit' value='수정하기' class='btn-primary'/>");
		out.println("<input type='reset' value='취소' class='btn-warning'/>");
